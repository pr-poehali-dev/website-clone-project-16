      ...
      <section className="max-w-[1200px] mx-auto px-4 pb-12 md:pb-20">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="relative h-[400px] hidden md:block">
            ...
            <img src="https://cdn.poehali.dev/projects/db6af359-6876-4ac9-8d16-d1dce02a757a/bucket/ad63ee3b-30b2-4c37-8e21-d8db1f157043.png" className="absolute bottom-0 left-0 w-64 h-64 rounded-full shadow-lg border-4 border-white overflow-hidden" style={{ objectFit: 'cover', objectPosition: 'center', transform: 'scale(1.25)', transformOrigin: 'center' }} alt="" />
          </div>
