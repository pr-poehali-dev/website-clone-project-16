...
const IF_CARDS_MOBILE = [
  ...
  <>Хотите сделать<br /><b>стильные изделия</b><br />для своего дома</>,
  <>Ищете хобби, которое<br /><b>поможет отдохнуть</b><br />от повседневной суеты</>,
  ...
  <>Никогда не плели, но<br /><b>хотите научиться</b></>,
];
...
export default function Index() {
  ...
  useEffect(() => {
    ...
    if (fa) {
      ...
      if (subid) img.src = img.src + '&subid=' + subid.value;
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#1F5B4E] overflow-x-hidden">
      ...
      <section className="max-w-[1200px] mx-auto px-4 pb-12 md:pb-20">
        ...
        <p className="text-center font-bold text-[#1F5B4E] text-base md:text-xl mb-3">
